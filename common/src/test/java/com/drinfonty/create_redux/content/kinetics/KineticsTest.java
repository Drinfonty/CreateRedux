...
public class KineticsTest {
	...
	void testConfigurationDefaults() {
		com.drinfonty.create_redux.infrastructure.config.CKinetics kinetics = com.drinfonty.create_redux.infrastructure.config.AllConfigs.server();
	...
	void testContraptionAssembly() {
		com.drinfonty.create_redux.content.contraptions.components.structure.bearing.BearingContraption contraption =
				new com.drinfonty.create_redux.content.contraptions.components.structure.bearing.BearingContraption(net.minecraft.core.Direction.UP);
